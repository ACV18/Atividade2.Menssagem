...
namespace Atividade2.Messagem
{
    internal class Program
    {   
        const string QueueConnectionString = "Endpoint=sb://geekburgueraldocesar.servicebus.windows.net/;SharedAccessKeyName=ProductPolicy;SharedAccessKey=3p9nG2bYKZZ60Z3LQvaxsGq5HFX6A118mRSWHhlEJx4=";
